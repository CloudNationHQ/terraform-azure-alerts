This example illustrates one alert processing rule action group. Multiple alert processing rule action groups can be added under the alert_processing_rule_action_groups key.
